...
let B = new Point(new Vector2d(900,600),20,"Orange","B",true);
let C = new Point(new Vector2d(400,400),20,"yellow","C",true);

let D = new Point(new Vector2d(200,200),5,"Red","A",false);
let E = new Point(new Vector2d(900,600),5,"Red","B",false);
let F = new Point(new Vector2d(400,400),5,"Red","C",false);

let S = new Point(new Vector2d(0,0),10,"Silver","S",false)

let M = new Point(new Vector2d(width/2,height/2),10,"rgba(0,0,0,0)","",false);
...
function animate()
{
    ...
    o.defineLineWithTwoPoints(B,D);
    p.defineLineWithTwoPoints(C,E);
    q.defineLineWithTwoPoints(A,F);
